...
- Wire names, AWG, and cut length displayed directly on routed wire labels.
...
- Wider default drawing spacing plus draggable wire routes with up to ten saved 90-degree bend points per wire.
